...
const SpecialMenu = () => (
  <div className="text-white bg-[#0c0c0c] text-center h-[160vh] w-full ">
    ...
    <div name="menu" className="lg:grid grid-cols-3">
      <div className="mt-4">
        <p className="font-base lg:text-[45px] cursor-default">Wine & Beer</p>
        {data.wines.map((wine, index) => (
         <MenuItem key={wine.title + index} title={wine.title} price={wine.price} tags={wine.tags}/>
        ))}
      </div>
      <div>
        <img src={images.wine} alt="menu" className="lg:mt-[120px] lg:h-[400px] w-[350px] ml-8 mt-5 lg:w-[450px] cursor-pointer hover:scale-105 duration-500"/>
      </div>
      <div className="mt-4 bg-[#0c0c0c]">
        <p className="font-base lg:text-[45px] cursor-default">Cocktails</p>
