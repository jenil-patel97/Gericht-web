...
const Footer = () => (
  <div className="bg-black-tail lg:grid grid-cols-3 bg-center bg-cover bg-repeat bg-fixed lg:h-[60vh] h-[90vh] py-[100px]">
    <div className="text-center flex-1 cursor-default">
      <h1 className="lg:text-[35px] text-[22px] text-white font-base">Contact Us</h1>
      ...
      <p className="text-[#e2c55a] font-base lg:text-[19px] text-[21px] lg:mt-2 mt-1 mb-12">+1 212-555-1230</p>
    </div>

    <div className="text-center flex-1 cursor-default">
      <img className="lg:w-[240px] w-[220px] ml-[85px] lg:-mt-5" src={images.gericht} alt="logo" />
    ...
    <div className="text-white text-center flex-1 cursor-default">
      <h1 className="lg:text-[35px] text-[22px] font-base mt-6 lg:-mt-2">Follow Us</h1>
